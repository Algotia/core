...
const paperTradeTests = async (
	...
	await describe("paperTrade", async () => {
		await it(`should create market order each candle`, async () => {
		...
		await it(`Paper trade: cancel all orders`, async () => {
			const clock = sinon.useFakeTimers();
